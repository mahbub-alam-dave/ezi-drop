    ...
    <div className="bg-[var(--color-bg)] dark:bg-[var(--color-bg-dark)] px-6 md:px-8">
      <div className="max-w-[1440px] mx-auto flex justify-between items-center h-[100px]">
        ...
        <div className="flex items-center gap-8">
          ...
          <button className="border-none btn bg-[var(--color-primary)] dark:bg-[var(--color-primary-dark)] rounded-sm text-white">
            Login
          </button>
          <button onClick={toggleTheme}>{dark ? "☀️ Light" : "🌙 Dark"}</button>{" "}
        </div>
      </div>
    </div>
  );
