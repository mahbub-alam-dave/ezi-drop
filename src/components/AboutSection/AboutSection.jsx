      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="relative w-full flex justify-center">
          <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-2xl overflow-hidden shadow-lg">
            <Image
              src="https://i.ibb.co.com/YF41TV2N/img-about-1-3.png"
          ...
          <div className="absolute bottom-0 left-0 w-40 h-40 rounded-xl overflow-hidden shadow-md border-4 border-white">
            <Image
              src="https://i.ibb.co.com/wZzP1pmV/img-about-1-1.png"
        ...
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <button
              type="button"
              className="flex items-center gap-2 px-5 py-2 rounded-lg bg-[#FEC201] text-[#034460] hover:opacity-90"
            >
