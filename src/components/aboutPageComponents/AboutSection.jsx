  ...
  return (
    <section id="about" className="w-full py-16">
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          <h2 className="text-3xl md:text-4xl color-text font-bold mb-3">
          ...
          <div className="prose max-w-none text-justify">
            {children ?? (
              <p className="text-color-soft">
                ...
                distribution. The role of logistics companies has become
                increasingly important in recent years due to the growth of
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a
              href="/contact"
              className="inline-block font-semibold px-5 py-2 rounded-lg border shadow-sm hover:shadow-md"
            >
              Calculate Package
            </a>
            <button
