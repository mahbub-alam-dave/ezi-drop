      ...
      <div className="max-w-[1440px] mx-auto space-y-28">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-lg md:text-xl text-[var(--color-subtext)] dark:text-[var(--color-subtext-dark)]">
            Have a question about delivery, partnership, or support? We’re here
            to help you 24/7.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <p className="text-[var(--color-subtext)] dark:text-[var(--color-subtext-dark)]">
              Reach out via email, phone, or visit one of our branches. Our
            ...
            <div className="space-y-4">
              <p className="flex gap-3 items-center text-[var(--color-subtext)] dark:text-[var(--color-subtext-dark)]">
                <FaLocationDot className="text-[var(--color-primary)]" /> Dhaka,
                Bangladesh
              </p>
              <p className="flex gap-3 items-center text-[var(--color-subtext)] dark:text-[var(--color-subtext-dark)]">
                <FaPhoneAlt className="text-[var(--color-primary)]" /> +880
                1234-567890
              </p>
              <p className="flex gap-3 items-center text-[var(--color-subtext)] dark:text-[var(--color-subtext-dark)]">
                <MdMarkEmailRead className="text-[var(--color-primary)]" />{" "}
                support@ezidrop.com
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            {status === "error" && (
              <p className="text-red-500 font-medium">
                Please select an enquiry type before submitting.
              </p>
            )}
        ...
        >
          <h2 className="text-3xl font-bold text-[var(--color-text)] dark:text-[var(--color-text-dark)] text-center mb-6">
            Our Branches
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="bg-[var(--color-card)] dark:bg-[var(--color-card-dark)] rounded-3xl shadow-lg p-6 text-center"
              >
                <h3 className="text-xl font-semibold text-[var(--color-text)] dark:text-[var(--color-text-dark)]">
                  {branch.city}
                </h3>
                <p className="text-[var(--color-subtext)] dark:text-[var(--color-subtext-dark)]">
                  {branch.address}
            ...
            {[
              {
                ...
                email: "rahim@ezidrop.com",
                image: "/customer 2.jpg",
              },
              {
                name: "Karim",
                role: "Logistics Manager",
                email: "karim@ezidrop.com",
                image: "/customer 3.jpg",
              },
              {
                name: "Ayesha",
                role: "Operations",
                email: "ayesha@ezidrop.com",
                image: "/customer 1.jpg",
              },
            ].map((member, i) => (
              <div
                key={i}
                className="bg-[var(--color-card)] dark:bg-[var(--color-card-dark)] p-8 rounded-2xl shadow-lg text-center"
              >
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="bg-[var(--color-card)] dark:bg-[var(--color-card-dark)] rounded-3xl shadow-lg p-10 space-y-4"
        >
          <h2 className="text-3xl font-bold text-[var(--color-text)] dark:text-[var(--color-text-dark)]">
            Our Policies
          </h2>
          <ul className="list-disc list-inside text-[var(--color-subtext)] dark:text-[var(--color-subtext-dark)]">
            <li>
              Delivery Policy: Fast & reliable delivery across major cities.
            </li>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="bg-[var(--color-card)] dark:bg-[var(--color-card-dark)] rounded-3xl shadow-lg p-10 text-center"
        >
          <h2 className="text-3xl font-bold text-[var(--color-text)] dark:text-[var(--color-text-dark)]">
            Need Instant Help?
          </h2>
          <p className="text-[var(--color-subtext)] dark:text-[var(--color-subtext-dark)] mb-4">
            Chat with our support team (coming soon)
          </p>
          <Link href="/dashboard/user/userChat">
            <button className="bg-[var(--color-primary)] hover:bg-[var(--color-primary-dark)] text-white font-semibold px-8 py-3 rounded-xl">
              Start Chat
            </button>
          </Link>
        </motion.div>
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {["behind-1.jpg", "behind-2.jpg", "behind-3.jpg"].map((img, i) => (
              <div
                key={i}
                className="h-48 bg-[var(--color-card)] dark:bg-[var(--color-card-dark)] rounded-2xl shadow-lg bg-cover bg-center"
